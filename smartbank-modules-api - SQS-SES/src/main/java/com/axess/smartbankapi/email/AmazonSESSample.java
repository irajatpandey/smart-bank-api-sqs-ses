package com.axess.smartbankapi.email;
...
public class AmazonSESSample {
    ...
    // This address must be verified.
	 static final String FROM = "rajatpandey7800@gmail.com";
	    static final String FROMNAME = "Rajat";
    ...
    public static void send(com.axess.smartbankapi.model.Message message) throws Exception {
        ...
        msg.setRecipient(Message.RecipientType.TO, new InternetAddress(message.getEmailId()));
